...
function Home() {
  return (
    <div className="home">
      <div className="banner w-full border border-red-600">
        <div className="banner-container container mx-auto">
          <div className="banner-description">
            ...
            <a href="#/" className="text-regular font-medium">
              View more
            </a>
          </div>
        </div>
      ...
      <main className="marketplace-products w-100 py-24 bg-[#F5F3F5]">
        <div className="products-categories container mx-auto">
          <h1 className="title-1 text-center md:text-left">
            WE HAVE WHAT YOUR ARE LOOKING FOR
          </h1>
          <div className="category-1 w-100 flex items-center justify-between relative">
            <div className="category-name-img w-60 flex flex-col items-center">
              ...
              />
              <h4 className="text-regular font-medium py-2 px-6 rounded-full -mt-4 bg-white">
                ELECTRONICS
              </h4>
            </div>
